...
?>
 <?php
  if(isset($_POST["datban"])){
	...
	$time = $_POST["time"];
    $people = $_POST["people"];
   $insert = mysqli_query($conn,"INSERT INTO `datban` (`name`, `email`, `phone`, `date`, `time`, `people`)  VALUES ('$name', '$email', '$phone', '$date', '$time', '$people')");
  }
?>
...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet" href="party2.css">
...
<header>
        ...
        <ul>  
            ...
            <li><a class="home" href="index.php"><img style="height:20px;width:20px" src="images/home.png" alt="Trang chủ"></a></li>  
